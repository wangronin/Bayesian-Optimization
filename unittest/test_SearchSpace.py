...
def test_Variable():
    ...
    assert x._bounds_transformed[0] == -20
    assert np.isclose(x._bounds_transformed[1], 0.6989700043360189)
...
def test_scale():
    ...
    assert C.data[0]._bounds_transformed[0] == -np.log(2)
    assert C.data[0]._bounds_transformed[1] == np.log(2)
